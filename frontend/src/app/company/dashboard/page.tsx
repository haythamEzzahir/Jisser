...
const steps = [
  ...
  },
  {
    ...
    action: { label: "Publier", href: "/company/needs" },
  ...
  },
  {
    ...
    action: { label: "Étudiants", href: "/company/assigned-students" },
    check: (_p: any, _needs: CompanyNeed[], roi: ROI | null) =>
  ...
  },
  {
    ...
    action: { label: "ROI", href: "/company/roi" },
    check: (_p: any, _needs: CompanyNeed[], roi: ROI | null) =>
      ...
      <Card className="overflow-hidden border-t-2 border-t-secondary">
        <CardHeader>
          <div className="flex items-center gap-2">
            ...
            <CardTitle>Bien démarrer sur Jesser</CardTitle>
          </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              ...
              <Button asChild variant="outline">
                <Link href="/company/assigned-students">
            ...
            <div className="space-y-3">
              ...
              {needs.length > 5 && (
                <Button asChild variant="ghost" className="w-full">
                  <Link href="/company/needs">Voir tout ({needs.length})</Link>
                </Button>
              )}
            </div>
          </CardContent>
