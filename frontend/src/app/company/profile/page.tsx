...
export default function CompanyProfilePage() {
  ...
  useEffect(() => {
    ...
    if (!loading && profile && profile.role !== "company") router.push("/dashboard");
        ...
        <Card className="overflow-hidden border-none shadow-lg border-t-2 border-t-secondary">
          ...
          <CardContent className="space-y-5">
            <div className="space-y-1.5">
              ...
              <Input value={form.company_name} onChange={(e) => update("company_name", e.target.value)} placeholder="Jesser SARL" required />
            </div>
